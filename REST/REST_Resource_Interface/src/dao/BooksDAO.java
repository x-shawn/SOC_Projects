...
public final class BooksDAO {
	...
	static {
		Book b1 = new BookBuilder("1", "RESTful Web Services").year(2010)
				.author("O'Reilly")
				.detail("http://oreilly.com/catalog/9780596529260").build();

		Book b2 = new BookBuilder("2", "RESTful Java with JAX-RS").year(2011)
				.author("O'Reilly")
				.detail("http://oreilly.com/catalog/9780596158057")
				.status("persistent").build();
		
		Book b3 = new BookBuilder("3", "REST in Action").price(120).year(2012)
				.author("O'Reilly")
